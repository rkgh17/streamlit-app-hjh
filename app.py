...
- DATA FROM [URL](https://archive.ics.uci.edu/ml/datasets/Iris)
...
def main(): 
    ...
    # 메뉴
    menu = ['Home','자료 분석과 시각화','머신러닝 예측','About']
